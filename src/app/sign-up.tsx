...
export default function SignUp() {
  ...
  async function onSubmit({ email, password }: SignUpFields) {
    setServerError('');
    setSuccessMessage('');
      ...
      >
        <View style={styles.container}>
          ...
          <Text style={[styles.toggleText, { color: theme.textSecondary }]}>
            ...
            <Link href={'/sign-in' as Href} style={[styles.toggleLink, { color: theme.text }]}>
              {t('auth.signIn')}
            </Link>
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  successText: { fontSize: 13, color: SUCCESS_COLOR },
