...
export const getQuickActions = (t: TFunction): Action[] => [
  // {
  //   id: 'new-alarm',
  //   title: t('quickAction.newAlarm.title'),
  //   subtitle: t('quickAction.newAlarm.subtitle'),
  //   icon: isAndroid ? 'shortcut_new_alarm' : 'alarm',
  //   params: { href: '/alarm/create-alarm' },
  // },
  // {
  //   id: 'dashboard',
  //   title: t('quickAction.dashboard.title'),
  //   subtitle: t('quickAction.dashboard.subtitle'),
  //   icon: isAndroid ? 'shortcut_dashboard' : 'symbol:chart.bar.xaxis.ascending',
  //   params: { href: '/(tabs)/dashboard' },
  // },
  // {
  //   id: 'achievements',
  //   title: t('quickAction.achievements.title'),
  //   subtitle: t('quickAction.achievements.subtitle'),
  //   icon: isAndroid ? 'shortcut_achievements' : 'symbol:trophy.fill',
  //   params: { href: '/achievements' },
  // },
  // {
  //   id: 'settings',
  //   title: t('quickAction.settings.title'),
  //   subtitle: t('quickAction.settings.subtitle'),
  //   icon: isAndroid ? 'shortcut_settings' : 'symbol:gearshape.fill',
  //   params: { href: '/(tabs)/settings' },
  // },
  {
    id: 'feedback',
    title: t('quickAction.feedback.title'),
